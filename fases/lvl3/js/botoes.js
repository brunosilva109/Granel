// Importa a nova função 'rotateCamera'
import { moveState, attemptJump, rotateCamera } from './player.js';
import { triggerInteraction } from './interaction.js'; // Importa a função de gatilho
...
export function setupMobileControls() {
    ...
    document.body.addEventListener('touchstart', (e) => {
        // Ignora toques que começam nos botões
    ...
    document.body.addEventListener('touchmove', (e) => {
        // Ignora toques nos botões
        if (e.target.closest('#mobile-controls')) return;
        
        // Impede a página de rolar enquanto o jogador olha ao redor
        e.preventDefault();
        ...
        // Chama a função centralizada do player.js para girar a câmera
        rotateCamera(deltaX, deltaY);

        // Atualiza a última posição do toque para o próximo movimento
