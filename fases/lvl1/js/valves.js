...
export async function setupValves(mainScene, mainWorld) {
    ...
    const valveLayout = [
        { motorId: 1, pos: { x: -14.7, z: 50 } }, { motorId: 1, pos: { x:-2.4, z: 50  } },
        { motorId: 2, pos: { x: -14.7, z: 40 } }, { motorId: 2, pos: { x: -2.4, z: 40} },
        { motorId: 3, pos: { x: -14.7, z: 30 } }, { motorId: 3, pos: { x:  -2.4, z: 30  } },
    ];
