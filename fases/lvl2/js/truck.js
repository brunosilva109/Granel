...
let truckMovement = {
    ...
    refueled: false
        ...
        function createTruckConnector(truckGroup, rua) {
        ...
        function createTruck(posX = 0, posY = 0, posZ = 0, rua) {
            ...
            createTruckConnector(tankTruck,rua);
        ...
        function addTruck(posX = 0, posY = 0, posZ = truckMovement.startZ, rua) {
            if (currentTruck) {
                scene.remove(currentTruck);
                objects = objects.filter(obj => !obj.userData.isTruckCollision);
            }

            currentTruck = createTruck(posX, posY, posZ,rua);
        ...
        function updateTruckMovement() {
            ...
            switch (truckMovement.state) {
                ...
                case 'pausing':
                    if (now - truckMovement.startTime >= truckMovement.pauseDuration && refuelProgress>=100) {
                        let tudoFechadoDesligado = verificar();
                        if(tudoFechadoDesligado){
                        ...
                        if (!truckMovement.selectedMotor && refuelProgress==0) {
                        ...
                        selectedMotorId = truckMovement.selectedMotor;
