...
export async function setupValves(mainScene, mainWorld) {
    ...
    const valveLayout = [
        ...
        { motorId: 4, pos: { x: -15.7, z: 8.1 } }, { motorId: 4, pos: { x: -23, z: 12.7 } },
        { motorId: 5, pos: { x: -14.2, z: -.9 } }, { motorId: 5, pos: { x: -22.8, z: -.9 } },
        { motorId: 6, pos: { x: -15.7, z: -9.7 } }, { motorId: 6, pos: { x: -23, z: -14.4 } },
    ];
