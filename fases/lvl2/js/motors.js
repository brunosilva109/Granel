...
export function setupMotors(mainScene, mainWorld) {
    ...
    const motorLayout = [
        // Lado Direito   
        { id: 1, pos: { x: 18.7, z: 8.1 }, side: 'right' },
        { id: 2, pos: { x: 17, z: -.9 }, side: 'right' },
        { id: 3, pos: { x: 18.7, z: -9.7 }, side: 'right' },
        // Lado Esquerdo
        { id: 4, pos: { x: -18.7, z: 8.1 }, side: 'left' },
        { id: 5, pos: { x: -17.2    , z: -0.9 }, side: 'left' },
        { id: 6, pos: { x: -18.7, z: -9.7 }, side: 'left' },
    ];
...
function createMotor(baseX, baseY, baseZ, id, side) {
    ...
    scene.add(motorGroup);
     let posXC;
     if(baseX>=0) posXC =baseX-6.5;
     else posXC =baseX+6.5;
    const motorConnectorPosition = new THREE.Vector3(posXC, 0.6, baseZ); 
